...
Java_com_example_opencv_1example_MainActivity_loadCascade(JNIEnv *env, jobject instance,
...
Java_com_example_opencv_1example_MainActivity_detect(JNIEnv *env, jobject instance,
